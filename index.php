            ...
            <div class="login-box ptb--100">
                <form method="POST" name="signin">
                    <div class="login-form-head">
                        <h4 style="color: #00008B">Leave Management System</h4>
                        <p style="color: #FF8C00;">Iclix (Pty) Ltd</p>
                    ...
                    <div class="login-form-body">
                        <div class="form-gp">
                            ...
                            <i class="ti-email" style="color: #00008B"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputPassword1">Password</label>
                            <input type="password" id="password" name="password" autocomplete="off" required>
                            <i class="ti-lock" style="color: #00008B"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="row mb-4 rmber-area">
                            ...
                            <div class="col-6 text-right">
                                <a href="password-recovery.php" style="color: #00008B">Forgot Password?</a>
                            </div>
                        </div>
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted"><a href="admin/index.php" style="color: #FF8C00;">Sign in as management</a></p>
                        </div>
                    </div>
                </form>
            </div>
